    ...
    functions: [
      {
        ...
        confidence: 0.72,
        callers: ["0x100004120"],
        // Two extra unknown-address callees so procedure(callees) returns >=3
        // entries. They exercise the unknown-ref fallback (addr-as-name) and
        // give the max_lines truncation regression a list big enough to cap.
        callees: ["0x100004010", "0x10000fff8", "0x10000fffc"],
        strings: ["license_key"],
