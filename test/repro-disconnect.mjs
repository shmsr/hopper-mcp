...
// Same shape as the failed batch, but restricted to the current Hopper-native
// tool surface.
const BATCH = [
  ["capabilities", {}],
  ...
  ["xrefs", { address: "0x100000610", session_id: SESSION }],
  ["containing_function", { address: "0x100000610", session_id: SESSION }],
];
